 ...
 */
export const PNL_NOT_COMPUTED_NOTE =
  "The reader is asking for profit, loss, or what a position cost. Nothing here computes that: profit " +
  "needs every acquisition priced at the moment it happened, and nothing here assembles it. " +
  "THIS NOTE IS AN INSTRUCTION, NOT A DRAFT. Write the answer in your own words and in the reader's " +
  "language; do not copy any sentence from this note, do not quote it, and do not carry its capitals " +
  "into your reply. Never name a tool, a lookup or a function to the reader — they do not know those " +
  "exist, and telling them to go and run one is not an answer. " +
  "Open by saying that working out whether this address is up or down is not something you can do. " +
  "Never say a transaction history, a page or a balance could not be read: nothing failed here, and " +
  "describing an outage that did not happen sends the reader back to retry something that will never " +
  "work. Missing capability, not missing data. " +
  "Then answer the rest normally from what you read — what the address holds and what it is worth, " +
  "whether it has ever sold, what it has traded recently — without estimating, implying or hedging a " +
  "profit figure anywhere. " +
  "If what you read shows tokens arriving by airdrop, disperse, distribution or migration, say so: " +
  "those were never bought, so no cost exists to compare against, and that answers the question better " +
  "than a number would.";
...
export async function runToolLoop({
  ...
  if (asksForCostBasis(question)) {
    messages.push({ role: "system", content: PNL_NOT_COMPUTED_NOTE });
  }
