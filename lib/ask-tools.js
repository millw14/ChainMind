 ...
 * the interface it routes through — eighteen tools, and one dispatcher that
 ...
 * search for a half-remembered ticker. Five more are the WALLET and MARKET side
 ...
 *
 * THE EIGHTEENTH IS NOT A LOOKUP. ask_clarification reads nothing from the chain:
 ...
 * readings (the largest holder, the deployer who minted it, the address most in
 * profit), listed two holders and closed with "the main benefactor of this coin
 * is not known". Three questions were on the table; guessing one and half
