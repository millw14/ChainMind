      ...
      <div className="border-b border-cm-border-subtle px-4 pb-6 pt-5 sm:px-6 sm:pt-6">
        <div className="mx-auto max-w-5xl">
          <div className="flex flex-wrap items-baseline justify-between gap-3">
            <h1 className="text-xl font-semibold tracking-tight text-cm-text sm:text-2xl">Console</h1>
          ...
          <p className="mt-2 max-w-2xl text-xs leading-relaxed text-cm-muted sm:text-sm">
            ...
            on the host; optional <code className="font-mono text-[11px] text-cm-subtle">TURSO_*</code> for cloud panels.
          </p>
        </div>
      </div>
      <Dashboard />
