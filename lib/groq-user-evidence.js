...
export function buildGroqUserEvidence(fullSnapshot) {
  ...
  return {
    ...
    peakBucketWalletCount:
      typeof d.peakBucketWalletCount === "number" && Number.isFinite(d.peakBucketWalletCount)
        ? d.peakBucketWalletCount
        : null,
    transferEdgesSample: Array.isArray(d.transferEdgesSample)
    ...
    ...(d.windowMinutes != null && Number.isFinite(Number(d.windowMinutes))
      ? { windowMinutes: Math.round(Number(d.windowMinutes)) }
      : {}),
    ...(d.eventsCounted != null && Number.isFinite(Number(d.eventsCounted))
      ? { eventsCounted: Math.round(Number(d.eventsCounted)) }
      : {}),
    ...(Array.isArray(d.topPrograms) ? { topPrograms: d.topPrograms.slice(0, 8) } : {}),
    ...(d.typeBreakdown && typeof d.typeBreakdown === "object" && !Array.isArray(d.typeBreakdown)
      ? { typeBreakdown: d.typeBreakdown }
      : {}),
    ...(Array.isArray(d.drivers) ? { drivers: d.drivers } : {}),
    fundingNarrative: typeof d.fundingOverlap === "string" ? d.fundingOverlap : null,
    fundingGraph,
    entityLedger,
    accountAge,
    ...(d.aiDetection && typeof d.aiDetection === "object" ? { aiDetection: d.aiDetection } : {}),
    ...(d.walletLedgerAge && typeof d.walletLedgerAge === "object" ? { walletLedgerAge: d.walletLedgerAge } : {}),
  };
}
