...
export function displayNumber(n, kind = "usd") {
  ...
  // A real but tiny amount must not round to "$0.00", which reads as worthless
  // rather than small. Observed live: a wallet holding priced at fractions of a
  // cent was reported as "its value is $0.00" — the same class of mistake as
  // treating unknown as zero, one decimal place further down. A true zero still
  // prints $0.00, because that IS the value.
