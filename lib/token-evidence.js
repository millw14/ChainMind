 ...
 *
 * @param {string} query
 * @param {object} options - `calls` (indexer seam), `client`/`resolvePool` (the
 *   pool sweep's seam), `now`
 ...
 *
 * @param {string} query - ticker, company name or 0x contract address
 * @param {{ calls?: object, client?: object, resolvePool?: Function, now?: number }} [options]
 * @returns {Promise<{ ok: boolean, kind?: string, evidence?: object, error?: string }>}
 */
  ...
  try {
    ...
    return {
      ...
      evidence: {
        ...
        holdersMeasured: analysis.measured,
        holdersUnknown: analysis.unknown,
        // The statistics, over real holders with a readable history only.
        countedHolders: summary.holders,
        counted: summary.measured,
        exact: summary.exact,
        lowerBounds: summary.lowerBounds,
 ...
 *
 * @param {string} query - ticker, company name or 0x contract address
 * @param {{ calls?: object, client?: object, resolvePool?: Function, now?: number,
