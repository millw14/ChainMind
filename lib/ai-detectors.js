...
/**
 * Normalize a Turso `scope_baselines` row for `computeZScores` (zscore-engine).
 * @param {Record<string, unknown> | null} row
 */
function coerceStoredBaselineRow(row) {
...
export function runAiDetectors(opts) {
  ...
  const baselineForZ = coerceStoredBaselineRow(storedBaseline ?? null);
