 ...
 * the interface it routes through — twenty-two tools, and one dispatcher that
 ...
 *
 * THE TWENTY-SECOND IS NOT A LOOKUP. ask_clarification reads nothing from the chain:
