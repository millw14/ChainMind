 ...
 * testing in a tight loop. Tuning this layer is the wrong lever. The right
 * one is the short-lived cache in front of the hot reads that was specced and
 * never built: it removes the repeat calls entirely, and a cached table
 * survives an indexer wobble. A different indexer would also fix it.
 */
