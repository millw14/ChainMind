...
/**
 * Pre-rendered money/count strings, because models mis-place decimal points in
 * raw floats. Observed live: given marketCap 4160789.1145265275, llama-3.3
 * answered "$4,160,789,114.53" — the true figure inflated a THOUSANDFOLD by
 * absorbing the fractional digits into the integer part. A wrong market cap
 * stated confidently is the worst class of bug this product can ship, so the
 * model is handed a finished string to copy instead of arithmetic to do.
 *
 * @param {number|null} n
